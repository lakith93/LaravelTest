        ...
        <div class="card w-50">
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <h3 class="d-flex justify-content-center"> Update Zone </h3>
                </div>

                <form method="POST" action="/zone/{{$zone->id}}">
                    @csrf
                    @method('put')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7">
                            <input type="text" id="short_des" name="short_des" class="form-control"
                                   @error('short_des') style="border-color: red"
                                   @enderror value="{{ $zone->short_des }}">
                        </div>
                    </div>
