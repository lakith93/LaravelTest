        ...
        <div class="card w-50">
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <h3 class="d-flex justify-content-center"> Update Region </h3>
                </div>
...
{{--                                   @enderror value="{{ $region->zone_id }}" readonly>--}}
                    ...
                    <div class="row mb-3">
                        <div class="col-md-5 text-end">
                            <label for="code" class="form-label fw-bold">Region Code</label>
                            @error('code')
                            <div class="mt-1 text-danger small">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-7">
                            <input type="text" id="code" name="code" class="form-control"
                                   @error('code') style="border-color: red"
                                   @enderror value="{{ $region->code }}" readonly>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-5 text-end">
                            <label for="name" class="form-label fw-bold">Region Name</label>
                            @error('name')
                            <div class="mt-1 text-danger small">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-7">
                            <input type="text" id="name" name="name" class="form-control"
                                   @error('name') style="border-color: red" @enderror value="{{ $region->name }}">
                        </div>
                    </div>
